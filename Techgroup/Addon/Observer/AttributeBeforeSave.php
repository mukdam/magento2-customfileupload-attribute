        ...
        try {
            ...
            if ($object instanceof Attribute) {
                if ($object->getAttributeId() === null && $object->getFrontendInput() === 'file') {
                    ...
                    $object->setBackendModel('Techgroup\Addon\Model\ProductAttribute\Backend\FileUpload');
                    $object->setFrontendModel('Techgroup\Addon\Model\ProductAttribute\Frontend\FileUpload');
