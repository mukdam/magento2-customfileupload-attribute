...
namespace Techgroup\Addon\Controller\Adminhtml\File;
...
class Upload extends \Magento\Backend\App\Action {
    ...
    private function getImageUploader() {
        ...
        if ($this->imageUploader === null) {
            $this->imageUploader = \Magento\Framework\App\ObjectManager::getInstance()->get(\Techgroup\Addon\Model\FileUploader::class);
        }
